...
public class Administrator extends Controller
{
  ...
  public static void authenticate(String username, String password)
  {
    ...
    if ((admin != null) && (admin.checkPassword(password) == true))
    {
       ...
       * distinguish an admin, as a user could be logged in and type the route
       * for admin URLs and get into the restricted access areas. By putting a
       * new value in session, it can only be set if an admin is logged in.
       */
       ...
       * that will handle the next screen
       */
    ...
    else
    {
       ...
       * and that will redisplay login.html with error
       */
  ...
  public static Admin getCurrentAdmin()
  {
     ...
     * written to session on admin login
     */
  ...
  {
    /**
     * A logged in User should not be able to access this page inadvertently by
     * knowing the URL. In Administrator Controller, when an admin signs in, I
